                ...
                if (inTU) when (tuType) {
                    TU_BJ -> when (tran.p2 shr 3) {
                        ...
                        0x18 -> result = when (tran.p1) {
                            ...
                            3 -> "001A000000000000A00912345678901220111111111111"
                            4 -> "001A000000000000A00941310116627420101010101010"
                            5 -> "0002000000000001F40941310614672320200902141153"
                            6 -> "0001000000000000000941310614846620200902134559"
                            7 -> "00030000000000012C0941310000000020200121110637"
                            else -> null
                        }
                        ...
                        0x1E -> result = when (tran.p1) {
                            ...
                            1 -> "0600004131008443880205060000783509000001900000044C20200301002723783511355850FFFFFFFF000000000000"
                            2 -> "0600004131061525510200000001003100000001900000044C19900301190734453013664530FFFFFFFF000000000000"
                            3 -> "0600004131011662740200390000503000000000000000044C20101010101010503012135030FFFFFFFF000000000000"
                            ...
                            10 -> "06000000000000000002FE000000000E00000000000000044C20200516055013372012303720FFFFFFFF000000000000"
                            11 -> "0400004131061667670104001500290000000001900000044C20200512082655731004827310FFFFFFFF000000000000"
                            12 -> "0300000024002600220100060024441200000000000000044C20200512080753731004827310FFFFFFFF000000000000"
                            13 -> "0430500000034104020100030041000000000001900000044C20200408171307332003473320FFFFFFFF000000000000"
                            14 -> "0330500000033404070100030034000000000000000000044C20200408164504332003473320FFFFFFFF000000000000"
                            15 -> "060000000005380171FF08910171000100000012C00000000020200121110637301010083010FFFFFFFF000000000000"
                            16 -> "03791000000225310801020019002A0000000000000000044C20200725144407791012017910FFFFFFFF000000000000"
                            17 -> "037910000003511F010100030033000000000000000000044C20200723104639791012017910FFFFFFFF000000000000"
                            18 -> "0600004131011004890200000000000000000001900000044C20200716121327300003011680FFFFFFFF000000000000"
                            19 -> "0200004131012113140250000000000000000000000000044C20200714163016375502068040FFFFFFFF000000000000"
                            20 -> "0600004131012090840200030001000100000001900000044C20200719175704375012313750FFFFFFFF000000000000"
                            21 -> "0400000900090015050200730004900000000001900000444C20200724120454100011011000FFFFFFFF000000000000"
                            22 -> "0300000900090015040200730001900000000000000000044C20200724110840100011011000FFFFFFFF000000000000"
                            23 -> "040000413101727507010300030A000000000001900000044C20200805200841551002195510FFFFFFFF000000000000"
                            24 -> "030000413101727458010300030D000000000000000000044C20200805192706551002195510FFFFFFFF000000000000"
                    ...
                    TU_GEN -> when (tran.p2 shr 3) {
                        0x18 -> result = when (tran.p1) {
                            ...
                            11 -> "0003000258000000C80941310119722720200121152435"
                            12 -> "0002000320000000C80941310119722220200121140819"
                            13 -> "0002000000000003E80212345678901220191228144152"
                            14 -> "00020000000000012C0621008005109620200918150720"
                            else -> null
                        }
                        0x1A -> result = when (tran.p1) {
                            1 -> if (metro && inGate)
