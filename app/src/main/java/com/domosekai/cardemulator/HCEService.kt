            ...
            "00B2" ->
                ...
                result = when (cardType) {
                    ...
                    2 -> when (hexCommandApdu.substring(4, 8)) {
                        ...
                        // 0x18...
                        // 0x1E
                        "01F4" -> "0430500000024904070200020049000000000001900000044C19900301002723361012273610FFFFFFFF000000000000"
                        "02F4" -> "0330500000014004130200010040000000000000000000044C19900301190734361012273610FFFFFFFF000000000000"
                        else -> ""
                    }
