            ...
            "00B2" ->
                ...
                result = when (cardType) {
                    ...
                    2 -> when (hexCommandApdu.substring(4, 8)) {
                        ...
                        "03C4" -> "001A000000000000A00900003101165219900301190734"
                        // 0x1E
                        "01F4" -> "06305000000249040702278F0000000000000001900000044C20200301002723243013322430FFFFFFFF000000000000"
                        "02F4" -> "0630500000014004130200000010000000000000000000044C19900301190734454001011000FFFFFFFF000000000000"
                        "03F4" -> "0630500000014004130219190001000000000000000000044C19900301190734075502068040FFFFFFFF000000000000"
                        else -> ""
                    }
