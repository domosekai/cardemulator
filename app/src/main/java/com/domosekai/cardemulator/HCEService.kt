...
class HCEService : HostApduService() {
    ...
    override fun processCommandApdu(commandApdu: ByteArray?, extras: Bundle?): ByteArray {
        ...
        when (hexCommandApdu.substring(0, 4)) {
            // 1 YCT, 2 BJ TU, 3 Suzhou, 4 Shenzhen, 5 BJ OLD, 6 CU Fake, 7 Nantong TU, 8 TFT, 9 TFT Cika, 10 SPTC
            ...
            "00B2" ->
                ...
                result = when (cardType) {
                    ...
                    10 -> when (hexCommandApdu.substring(4, 8)) {
                        ...
                        "07C4" -> "00070000C8000000F00621420100058420200316144017"
                        "08C4" -> "00060001B8000000A00621420100058120200122453459"
                        "09C4" -> "0005000258000000C80941310119722720200121152435"
                        "0AC4" -> "000F000320000000C80941310119722220200121140819"
                        else -> ""
                    }
                    else -> ""
                }
