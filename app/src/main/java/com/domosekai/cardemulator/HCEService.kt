                ...
                if (inTU) when (tuType) {
                    TU_BJ -> when (tran.p2 shr 3) {
                        ...
                        0x1E -> result = listOf(
                            ...
                            "0445200000113205020200110032000000000001900000044C20200801134916452011984520FFFFFFFF000000000000", // qingdao metro
                            ...
                            "0600004131015076990202100000000000000001900000085C20201204214155300014005670FFFFFFFF000000000000", // huaihua 2
                            ...
                            "030000300799000120014F002F004F0000000000000000085C20210101165050100001011000FFFFFFFF000000000000", // beijing t1 qizhuang
                    ...
                    TYPE_SPTC -> when (tran.p2 shr 3) {
                        ...
                        0x18 -> result = when (tran.p1) {
                            ...
                            13 -> "0001000000000000C80600010020135720200101100000" // chengdu tu
                            14 -> "00020000000000012C0931500101046720200121110637" // yuyao train
                            else -> null
                        }
                    }
